...
class Fmeasure(object):
    ...
    def get_results(self,model_name,dataset) -> dict:
        """
        ...
        file = model_name + "_fmeasure_" + dataset + ".txt"
        with open(file, 'w') as f:
            for i in range(len(list(changeable_fm))):
                v = str(list(changeable_fm)[i])
                f.write(v + '\n')
        return dict(fm=dict(adp=adaptive_fm, curve=changeable_fm), pr=dict(p=precision, r=recall))
...
class MAE(object):
    ...
    def get_results(self,model_name,dataset) -> dict:
        ...
        file = model_name+"_mae_"+dataset+".txt"
        with open(file, 'w') as f:
...
class Smeasure(object):
    ...
    def get_results(self,model_name,dataset) -> dict:
        ...
        file = model_name + "_Smeasure_" + dataset + ".txt"
        with open(file, 'w') as f:
...
class Emeasure(object):
    ...
    def get_results(self,model_name,dataset) -> dict:
        ...
        # print(changeable_em)
        file = model_name + "_Emeasure_" + dataset + ".txt"
        with open(file, 'w') as f:
            for i in range(len(list(changeable_em))):
                v = str(list(changeable_em)[i])
                f.write(v + '\n')
        return dict(em=dict(adp=adaptive_em, curve=changeable_em))
